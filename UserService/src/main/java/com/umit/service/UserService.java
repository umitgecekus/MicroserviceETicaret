...
public class UserService {
    ...
    public void save(UserSaveRequestDto dto){
        User user = userRepository.save(User.builder()
                ...
                .build());
        /**
         * Bu islem exception firlatabilir, bu nedenle try catch ya da Object
         * null kontrolu yapariz.
         */
       ...
       // elasticUserManager.save(userRequestDto); 29,02,2024 dersi 01:10:00
    }
